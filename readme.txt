...
Contributors: marcari, topchretien
Donate link: https://www.topchretien.com/don/
Tags: topbible, topchretien, bible
...
Aide à l'insertion de versets Bibliques et de liens vers TopBible.com. // Helps inserting Bible verses and links to french-speaking site TopBible.com
...
Installing "TopBible for Wordpress" can be done either by searching for "TopBible for Wordpress" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
...
* Martin
* Pstervald
* Texte original Hébreux / Grec

= Puis-je modifier le texte insérer ? =

Oui, le plugin sert uniquement d'aide à l'insertion de texte, de référence et de lien. Une fois insérer vous pouvez tout à fait personnaliser la manière dont le verset est inséré.
